...
{
    ALGEBRAIC[73] = ALGEBRAIC[99] + ALGEBRAIC[84] + ALGEBRAIC[104] + ALGEBRAIC[87]
                  + ALGEBRAIC[103] + ALGEBRAIC[101] + ALGEBRAIC[100] + ALGEBRAIC[92]
                  + ALGEBRAIC[86] + ALGEBRAIC[88] + ALGEBRAIC[95] + ALGEBRAIC[62] + ALGEBRAIC[106]
                  + ALGEBRAIC[108]; // IKb
...
void calc_ryr(const double time, double *STATES, double *CONSTANTS, double *ALGEBRAIC, double *RATES)
{
    ...
    RATES[25] = 0; // (ALGEBRAIC[74] - STATES[25]) / CONSTANTS[48];
    RATES[26] = 0; // (ALGEBRAIC[69] - STATES[26]) / CONSTANTS[48];
    RATES[27] = 0; // (ALGEBRAIC[67] - STATES[27]) / CONSTANTS[48];
    RATES[28] = 0; // (ALGEBRAIC[60] - STATES[28]) / CONSTANTS[48];
    RATES[29] = 0; // (ALGEBRAIC[81] - STATES[29]) / CONSTANTS[49];
    RATES[30] = 0; // (ALGEBRAIC[75] - STATES[30]) / CONSTANTS[49];
    RATES[31] = 0; // (ALGEBRAIC[70] - STATES[31]) / CONSTANTS[49];
    RATES[32] = 0; // (ALGEBRAIC[57] - STATES[32]) / CONSTANTS[50];
    RATES[33] = 0; // (ALGEBRAIC[79] - STATES[33]) / CONSTANTS[46];
    RATES[34] = 0; // (ALGEBRAIC[78] - STATES[34]) / CONSTANTS[46];
    RATES[35] = 0; // (ALGEBRAIC[68] - STATES[35]) / CONSTANTS[46];
    RATES[36] = 0; // (ALGEBRAIC[51] - STATES[36]) / CONSTANTS[47];
